...
const List<ThemePresetDef> kThemePresets = [
  ...
  ThemePresetDef(ThemePreset.klasik, 'Classic', Color(0xFF1F2937), Color(0xFF374151), Color(0xFF6B7280)),
  ThemePresetDef(ThemePreset.canli, 'Vibrant', Color(0xFFEF4444), Color(0xFFF59E0B), Color(0xFF10B981)),
  ThemePresetDef(ThemePreset.pastel, 'Pastel', Color(0xFFF472B6), Color(0xFFA78BFA), Color(0xFF34D399)),
  ThemePresetDef(ThemePreset.okyanus, 'Ocean', Color(0xFF0EA5E9), Color(0xFF0284C7), Color(0xFF0891B2)),
  ThemePresetDef(ThemePreset.orman, 'Forest', Color(0xFF059669), Color(0xFF047857), Color(0xFF65A30D)),
  ThemePresetDef(ThemePreset.gunes, 'Sun', Color(0xFFF59E0B), Color(0xFFD97706), Color(0xFFEA580C)),
  ThemePresetDef(ThemePreset.lavanta, 'Lavender', Color(0xFF8B5CF6), Color(0xFF7C3AED), Color(0xFFA855F7)),
  ThemePresetDef(ThemePreset.gul, 'Rose', Color(0xFFEC4899), Color(0xFFDB2777), Color(0xFFBE185D)),
  ThemePresetDef(ThemePreset.grafit, 'Graphite', Color(0xFF475569), Color(0xFF334155), Color(0xFF1E293B)),
